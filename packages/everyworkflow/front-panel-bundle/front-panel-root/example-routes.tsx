...
const DataFormBlockPage = lazy(() => import("@everyworkflow/front-panel-bundle/page/example/data-form-block-page"));
const PageBuilderEditPage = lazy(() => import("@everyworkflow/front-panel-bundle/page/example/page-builder-edit-page"));
